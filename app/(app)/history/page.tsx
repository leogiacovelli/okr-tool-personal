...
/** Storico dei semestri del membro (solo i propri, con OKR Result finale). */
export default async function HistoryPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-semibold">Storico semestri</h1>
        <p className="text-sm text-zinc-500 dark:text-zinc-400">
          I tuoi set di obiettivi passati e correnti, con il risultato finale.
        </p>
      </div>

      {sets.length === 0 ? (
        <p className="rounded-xl border border-dashed border-zinc-300 p-8 text-center text-sm text-zinc-500 dark:border-zinc-700">
          Nessun semestre ancora: inizia dalla pagina «I miei OKR».
        </p>
      ) : (
